...
function EnterpriseWechatStrategy(options, verify, getAccessToken, saveAccessToken) {
  ...
  if (!verify) {
    throw new Error('EnterpriseWechatStrategy requires a verify callback')
  }

  if (!options.corpId) {
    throw new Error('EnterpriseWechatStrategy requires a corpId option')
  }
  if (!options.corpSecret) {
    throw new Error('EnterpriseWechatStrategy requires a corpSecret option')
  }
  if (!options.agentId) {
    throw new Error('EnterpriseWechatStrategy requires a agentId option')
  }
  ...
  if (!_getAccessToken || !_saveAccessToken) {
    throw new Error('EnterpriseWechatStrategy requires \'getAccessToken\' and \'saveAccessToken\'')
  }

  passport.Strategy.call(this)
  this.name = 'enterprise-wechat'
  this._verify = verify
 ...
 */
util.inherits(EnterpriseWechatStrategy, passport.Strategy)
 ...
 * @api protected
 */
EnterpriseWechatStrategy.prototype.authenticate = function (req, options) {
  options = options || {}
  ...
  if (req.query && req.query.code) {
    ...
    async.waterfall([
      function (callback) {
        self._oauth.getAccessToken(callback)
      },
      function (accessToken, callback) {
        self._oauth.getUserInfo(accessToken, code, callback)
      }
...
module.exports = EnterpriseWechatStrategy
